    ...
    return(
        <>
            <section className="bg-gray-100 w-full flex pb-16 rounded">
                <div className="max-w-screen-xl flex-col m-auto justify-center py-12 flex gap-12 items-center w-[95%] ">
                    <div className="section-header text-center">
                        ...
                        <img src={img} className='w-64 m-auto mt-4' alt="tipos de cobranças" />
                    </div>
...
function Card({plan}){
    return(
        <>
            <div className="main bg-white rounded-lg shadow-2xl px-4 py-6 w-72 max-lg:w-80">
                ...
                <div className="card-main h-96 max-lg:h-60">
